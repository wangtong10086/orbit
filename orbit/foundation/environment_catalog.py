...
from orbit.env.base import EnvProtocol
from orbit.env.gem import GemEnv
...
def default_environment_catalog() -> EnvironmentCatalog:
    ...
    from orbit.env.game import GameEnv, GameGemEnv
    from orbit.env.lgc import LgcEnv, LgcGemEnv
    from orbit.env.liveweb import LivewebEnv, LivewebGemEnv
    from orbit.env.memorygym import MemorygymEnv
    from orbit.env.navworld import NavworldEnv, NavworldGemEnv
    from orbit.env.print_env import PrintEnv, PrintGemEnv
    from orbit.env.swe import SweEnv, SweGemEnv
