...
from orbit.foundation.data_contracts import DatasetBuildReport, PublishReport
...
from orbit.pipeline.data import DatasetBuildPipeline


def dataset_repo_id(repo_id: str | None = None) -> str:
    """Resolve the target HF dataset repo with env override support."""

    return repo_id or os.environ.get("HF_DATASET_REPO", "") or OrbitConfig.load().hf_dataset_repo
