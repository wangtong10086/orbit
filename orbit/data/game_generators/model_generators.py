...
from orbit.data.game_policy_models.inference import play_record as selfplay_record, resolve_policy_model_dir
        ...
        *,
        ...
        if not status.exists:
            raise FileNotFoundError(
                ...
                f"Run `orbit data game-selfplay-train --game {game_name}` first."
            )
