...
from orbit.foundation.data_contracts import validate_canonical_entry
...
class EnvProtocol:
    ...
    environment interaction, see GemEnv in orbit.env.gem.
    For runtime management, see Sandbox in orbit.env.sandbox.
    ...
    def prompt_builder(self):
        ...
        Lazy import to avoid circular dependency with orbit.prompt.
        """
