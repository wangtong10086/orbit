"""Centralized configuration for ORBIT."""
...
class OrbitConfig(BaseSettings):
    ...
    default_exec_image: str = Field(default="wangtong123/orbit:latest", validation_alias="AFFINE_DEFAULT_EXEC_IMAGE")
...
__all__ = ["OrbitConfig", "load_dotenv", "PROJECT_ROOT"]
