...
from orbit.core.audit.writer import AuditEvent, AuditWriter
from orbit.core.control.registry import TaskRegistry
from orbit.core.contracts.experiments import CreateExperimentRequest, RunLogsQuery, RunQuery, resolve_run_record_key, run_record_key
...
from orbit.core.experiments.models import AgentEvaluationRecord, Experiment, ExperimentResults, RunRecord, TrainingLifecycleState
...
from orbit.core.control.submission import normalize_submission
...
class CoreControlService:
    def __init__(
        ...
        self.bundle_dir_factory = bundle_dir_factory or (lambda experiment: tempfile.mkdtemp(prefix=f"orbit-control-{experiment.id}-"))
