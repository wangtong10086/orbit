...
from orbit.core.contracts.execution import ArtifactManifest, JobSpec, RunHandle, RunStatus
from orbit.foundation.schema import VersionedDocument
...
class JobBundle:
    ...
    def runtime_log_path(self) -> Path:
        return self.runtime_dir / "runtime.log"
    ...
    def append_runtime_log(self, message: str) -> Path:
        self.ensure_structure()
    ...
    def record_local_artifacts(self) -> ArtifactManifest:
        ...
        for path in sorted(self.runtime_dir.rglob("*")):
