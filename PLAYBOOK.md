...
**v2.24: APPROVED** — GAME v10 9466 + NW 4148 + LW 8816 + SWE-I 848 = 23278. Audit passed.
...
| **v2.24** | ? | ? | ? | 23278 | GAME v10 rule-based think, LW tools fix |
...
| LW | 8816 | 37.9% | Tools fix, single-turn goto+stop (by design) |
