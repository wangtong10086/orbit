...
- **v2.19: ckpt-300 WORKING** — ckpt-50 ✅, ckpt-300 ✅, ckpt-351 ❌. Can eval ckpt-300 if needed.
- **v2.20: APPROVED** — GAME 9088 + NW 1768 + LW 2345 + SWE-I 629 = 13830. Save every 50 steps. Stability protocol: test final → use last working ckpt if broken.
