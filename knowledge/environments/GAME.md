...
| 1 | **liars_dice** | 3000,200r | 0% | **100% (3/3)** | 10000,50r | MCTS搜索 + 概率解释 |
| 2 | **leduc_poker** | 3000,200r | **60%** | — | — | 决策表 + fold J |
| 3 | **gin_rummy** | 500,10r | **50%** | — | — | meld + knock + discard |
| 4 | **othello** | 1000,20r | 20% | **40% (4/10)** | 3000,5r | MCTS搜索 + 位置解释 |
| 6 | **hex** | 1000,50r | **30%** | 0% (0/3) | 3000,10r | MCTS失败，保留minimax |
| 7 | **clobber** | 1500,100r | 0% | **67% (2/3)** | 5000,20r | MCTS搜索 + mobility解释 |
