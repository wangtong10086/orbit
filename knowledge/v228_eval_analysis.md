...
### ckpt2000 (step 2000, 41.3% training) — 过拟合信号
| Env | Score | Samples | Errors | vs Best |
|-----|-------|---------|--------|---------|
| GAME | 28.92 | 37 | 0 | -11.14 vs ckpt800 **下降严重** |
| NW | 30.51 | 43 | 0 | -13.57 vs ckpt600 **下降严重** |
| **LW** | **44.46** | 89 | 11 | **+16.70 vs 27.76 NEW ALL-TIME BEST** |
| **SWE-I** | **20.00** | 10 | 0 | **首次超过竞对 14.00!** (early) |
| MG | 51.2% | 4 scores | 0 | early |

**ckpt2000 关键发现**: GAME/NW 严重退化，LW/SWE 大幅提升。训练过半后出现明显的多任务 trade-off。
...
GAME     32.26     36.23     40.06     39.35     28.92↓↓   峰值 ckpt800
NW       37.41     44.08     37.50     39.73     30.51↓↓   峰值 ckpt600
LW       25.19     38.45     37.63     39.66     44.46↑↑   持续上升
SWE      0.00      0.00      4.55      5.26      20.00↑↑   持续上升
MG       —         51.5%     58.8%     46.2%     51.2%     波动 ~50%
```
...
| LW/SWE 最优 | **ckpt2000** | 28.9 | 30.5 | **44.5** | **20.0** |
...
| SWE | 0.00 | 20.00 (ckpt2000) | from 0 |
...
|-----|--------------|--------------|-----|
| GAME | 28.92 | 47.05 (vera6) | -18.13 |
| NW | 30.51 | 39.12 (Sanguineey) | -8.61 |
| LW | 44.46 | 28.42 (RLStepone) | **+16.04 领先** |
| SWE-I | 20.00 | 14.00 (EdmondMillion) | **+6.00 领先** |
