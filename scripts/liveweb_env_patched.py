...
class Actor:
    ...
    async def _run_evaluation(
        ...
        try:
            ...
            # Validator uses separate API (VALIDATOR_BASE_URL/VALIDATOR_API_KEY)
            _v_url = os.getenv("VALIDATOR_BASE_URL", "https://llm.chutes.ai/v1")
            _v_key = os.getenv("VALIDATOR_API_KEY") or os.getenv("API_KEY") or api_key
            validator_client = LLMClient(base_url=_v_url, api_key=_v_key)
