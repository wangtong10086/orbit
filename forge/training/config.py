...
'''
    ...
    def to_dpo_script(self, dataset_path: str, sft_adapter: str = "") -> str:
        """Generate DPO training script. Delegates to forge.training.dpo_config."""
        from forge.training.dpo_config import generate_dpo_script
        return generate_dpo_script(self, dataset_path, sft_adapter)
