...
forge control submit-train <exp-id> tmp/train.jsonl --runtime targon --profile image --image wangtong123/affine-forge:latest --dataset-repo <repo> --gpu-type H200
forge control submit-eval <exp-id> --model Qwen/Qwen2.5-0.5B-Instruct --envs GAME --runtime targon --profile image --image wangtong123/affine-forge:latest --dataset-repo <repo> --gpu-type H200
forge control submit-collect-navworld <exp-id> -n 1 --runtime targon --profile image --image wangtong123/affine-forge:latest --dataset-repo <repo> --gpu-type H200
